      ...
      <div className="relative ">
        <div style={{ position: "relative" }}>
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  text-center  w-[90%]  ">
            <div className="text-[#B4EF52] 2xl:text-4xl lg:text-3xl md:text-2xl sm:text-lg text-base  font-semibold sm:mb-[25px] ">
              Organic Made Easy
            </div>
            <div className="text-white 2xl:text-6xl lg:text-5xl md:text-4xl sm:text-xl text-base font-bold sm:mb-[15px] ">
