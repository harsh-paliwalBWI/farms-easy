...
const ProductCard = () => {
  return (
    <div className=' w-full'>
      <div className='border-[#479332] border-[1px] w-full p-[15px] rounded-md flex justify-center '>
        <div>
          ...
          <div className='flex items-center justify-between gap-3'>
            <div className='bg-[#479332] text-white text-xs px-[20px] py-[10px] rounded-md w-fit'>I’M Interested</div>
