...
const DUMMY_DATA = [{ heading: "Top Sells", items: [{ image: img, name: "Orange", qty: "10 kg", price: "1,333", disPrice: "4,455" }, { image: img, name: "Orange", qty: "10 kg", price: "1,333", disPrice: "4,455" }, { image: img, name: "Orange", qty: "10 kg", price: "1,333", disPrice: "4,455" }] },
            ...
            {/* <div className='flex justify-center gap-10'> */}
                {DUMMY_DATA.map((item: any, idx: number) => {
                    return <div className='w-[100%]  ' key={idx}>
                        <div className=''>
                        <div className='text-[#253D4E] sm:text-xl text-lg font-semibold mb-[10px] '>{item.heading}</div>
                        
                        <div className=" h-1 relative mb-[25px] sm:w-[80%] w-[60%]">
