          ...
          <div className='flex items-center justify-between '>
            ...
            <div className=' relative rounded-md border-[2px] border-[black]'>
                ...
                <div className='absolute bottom-[15px] px-[15px] w-full bst-sell-form'>
                    ...
                    <div className='text-xs font-bold mb-[5px]'><span >Email address</span><span className='text-[red]'>*</span></div>
                    <div className='flex items-center gap-2  w-full px-[10px] rounded-sm bg-[#FFFFFF] '><span><AiOutlineMail className="text-[#ADADAD] h-[15px] w-[15px]"/></span><input placeholder='johndoe@gmail.com' className='w-[90%] outline-0 py-[7px] '/></div>
                    </div>
                    <div className='mb-[30px]'>
                    <div className='text-xs font-bold mb-[5px]'><span >Password</span><span className='text-[red]'>*</span></div>
                    <div className='flex items-center gap-2 rounded-sm w-full px-[10px] bg-[#FFFFFF] mb-[10px]'><span><LuKey className="text-[#ADADAD] h-[15px] w-[15px]"/></span><input placeholder='johndoe@gmail.com' className='w-[90%] outline-0 py-[7px] '/></div>
                    </div>
