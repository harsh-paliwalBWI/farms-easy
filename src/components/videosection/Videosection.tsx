...
const Videosection = () => {
  return (
    <div className="relative flex items-center justify-center bg-cover  bg-videobg  px-[3.5%] ">
      <div className="py-[6rem]  flex flex-col  ">
        <h1 className="text-white text-4xl font-bold mb-[1rem]">
          Harmful Chemical Free{" "}
        </h1>
        <h1 className="text-white text-4xl font-bold mb-[5rem] ">
          Healthy Fresh Vegetables & Fruits!
        </h1>
