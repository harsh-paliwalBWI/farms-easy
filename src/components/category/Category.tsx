  ...
  return (
    <div className='bg-category-bg bg-cover bg-no-repeat md:py-[100px] py-[40px] sm:px-[3.5%] px-[7%] relative   '>
        <div className='text-center'>
            <div className='text-[#588F27] font-bold md:text-lg sm:text-base text-xs sm:mb-[10px] mb-[5px]'>What we offer for you</div>
            <div className='font-bold md:text-3xl sm:text-2xl text-xl md:pb-[30px] sm:pb-[30px]  text-[#253D4E]'>Explores by Category</div>
            <CategoryAvl/>
            <CategoryCard/>
        </div>
