      ...
      <div className="flex flex-wrap justify-center gap-[60px]  ">
        ...
        <div className="flex flex-col gap-[2rem] w-[47%]">
          <div className="flex justify-between ">
            <div className="font-medium  text-2xl text-[#598f26] underline underline-offset-4">
              Description
            </div>
            <div className="font-medium  text-2xl text-[#598f26] underline underline-offset-4">
          ...
          {DUMMY_DATA.features.map((feature,idx) => (
            <div key={idx} className=" text-sm font-medium  flex gap-2 items-center">
              {" "}
              <GoDotFill /> {feature}
            </div>
          ))}
