  ...
  return (
    ...
    <div className='w-[47%]'>
            <div className='flex flex-col gap-[2rem]'>
                ...
                <Image src={DUMMY_DATA.image2} alt='' className='' width={1000} height={1000}/> 
            </div>
        
    </div>
    <div className='flex flex-col gap-[2rem] w-[47%]'>
        <div className='flex justify-between '>
        <div className='font-medium  text-2xl text-[#598f26] underline underline-offset-4'>Description</div>
        <div className='font-medium  text-2xl text-[#598f26] underline underline-offset-4'>Additional Information</div>
        </div>
       
        <div className=' text-sm font-medium  leading-6'>{DUMMY_DATA.descriptiontext}</div>
       
        <div className='font-medium  text-2xl  mt-2'>Features</div>            
        {DUMMY_DATA.features.map((feature) => (
            <div className=' text-sm font-medium  flex gap-2 items-center'> <GoDotFill/>   {feature}</div>
                ))}
